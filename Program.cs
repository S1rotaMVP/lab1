...
namespace ConsoleApp1
{
    ...
    internal class Program
    {
        ...
        static void PurchaseFeed()
        {
            ...
            FeedItem[] purchases = new FeedItem[count];
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("Помилка: Назва надто коротка! Товар пропущено.");
                    Console.ResetColor();
                    continue;
                }
            ...
            double totalSum = 0;
            double maxPrice = 0;
            string mostExpensiveName = "Немає";
            int premiumCount = 0;
            ...
            double averagePrice = realCount > 0 ? totalSum / realCount : 0;
        ...
        static void ShowMenu()
        {
            ...
            Console.WriteLine("7. Закупівля кормів");
